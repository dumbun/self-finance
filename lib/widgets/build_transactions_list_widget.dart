...
import 'package:flutter/material.dart';
import 'package:self_finance/backend/itdata_database.dart';

class BuildTransactionsListWidget extends StatelessWidget {
  const BuildTransactionsListWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: BackEndDrift.fetchAllTransactions().asStream(),
