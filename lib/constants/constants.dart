const String pleaseEnterTheName = "Please Enter Your Name";
const String errorUserFetch = "Error of fetching User data";
...
const String noTransactionsFound = "sorry no transactions found. 🫠";
